...
$id = $_GET['id'];
$qry ="SELECT * FROM studentclasses WHERE id=$id";
...
?>
     ...
     <h1 class="text-3xl font-bold">Edit Class Info</h1>
 ...
 Grade" class="p-2 bg-gray-100 border rounded w-full block my-3">
        <input type="text" name="num" value="<?php echo $row['num']; ?>" placeholder="Enter Number of
